...
const COMMON = {
  ...
  SOCKET_PATH: process.env.SOCKET_PATH || "/socket.io/", // ⬅️ con slash final
  SOCKET_NAMESPACE: process.env.SOCKET_NAMESPACE || "",
  ONLY_WEBSOCKET: process.env.ONLY_WEBSOCKET || "false", // ⬅️ por defecto false
 ...
 * buscando variables del tipo DRIVER_<ID>_TOKEN
 */
